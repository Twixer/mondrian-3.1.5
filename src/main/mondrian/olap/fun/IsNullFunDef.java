/*
// $Id: //open/mondrian-release/3.1/src/main/mondrian/olap/fun/IsNullFunDef.java#2 $
 ...
 *
 * @author medstat
 * @version $Id: //open/mondrian-release/3.1/src/main/mondrian/olap/fun/IsNullFunDef.java#2 $
 * @since Aug 21, 2006
 */
