/*
// $Id: //open/mondrian-release/3.1/src/main/mondrian/olap/fun/IntersectFunDef.java#3 $
 ...
 *
 * @author jhyde
 * @version $Id: //open/mondrian-release/3.1/src/main/mondrian/olap/fun/IntersectFunDef.java#3 $
 * @since Mar 23, 2006
 */
