/*
// $Id: //open/mondrian-release/3.1/src/main/mondrian/olap/fun/GlobalFunTable.java#2 $
 ...
 *
 * @author Gang Chen
 * @version $Id: //open/mondrian-release/3.1/src/main/mondrian/olap/fun/GlobalFunTable.java#2 $
 */
