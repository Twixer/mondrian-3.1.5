/*
// $Id: //open/mondrian-release/3.1/src/main/mondrian/olap/fun/MemberOrderKeyFunDef.java#2 $
 ...
 *
 * @author kvu
 * @version $Id: //open/mondrian-release/3.1/src/main/mondrian/olap/fun/MemberOrderKeyFunDef.java#2 $
 * @since Nov 10, 2008
 */
