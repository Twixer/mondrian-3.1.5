/*
// $Id: //open/mondrian-release/3.1/src/main/mondrian/olap/fun/TupleToStrFunDef.java#2 $
 ...
 *
 * @author jhyde
 * @version $Id: //open/mondrian-release/3.1/src/main/mondrian/olap/fun/TupleToStrFunDef.java#2 $
 * @since Aug 3, 2006
 */
