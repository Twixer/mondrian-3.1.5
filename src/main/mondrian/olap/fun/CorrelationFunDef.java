/*
// $Id: //open/mondrian-release/3.1/src/main/mondrian/olap/fun/CorrelationFunDef.java#2 $
 ...
 *
 * @author jhyde
 * @version $Id: //open/mondrian-release/3.1/src/main/mondrian/olap/fun/CorrelationFunDef.java#2 $
 * @since Mar 23, 2006
 */
