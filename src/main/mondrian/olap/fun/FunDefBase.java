/*
// $Id: //open/mondrian-release/3.1/src/main/mondrian/olap/fun/FunDefBase.java#2 $
 ...
 *
 * @author jhyde
 * @version $Id: //open/mondrian-release/3.1/src/main/mondrian/olap/fun/FunDefBase.java#2 $
