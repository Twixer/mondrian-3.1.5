/*
// $Id: //open/mondrian-release/3.1/src/main/mondrian/olap/fun/ExistsFunDef.java#2 $
 ...
 *
 * @author kvu
 * @version $Id: //open/mondrian-release/3.1/src/main/mondrian/olap/fun/ExistsFunDef.java#2 $
 * @since Mar 23, 2008
 */
