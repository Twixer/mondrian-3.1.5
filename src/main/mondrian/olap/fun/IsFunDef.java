/*
// $Id: //open/mondrian-release/3.1/src/main/mondrian/olap/fun/IsFunDef.java#2 $
 ...
 * @see IsNullFunDef
 * @author jhyde
 * @version $Id: //open/mondrian-release/3.1/src/main/mondrian/olap/fun/IsFunDef.java#2 $
 * @since Mar 23, 2006
 */
