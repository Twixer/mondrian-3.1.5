/*
// $Id: //open/mondrian-release/3.1/src/main/mondrian/olap/fun/UnorderFunDef.java#2 $
 ...
 *
 * @author jhyde
 * @version $Id: //open/mondrian-release/3.1/src/main/mondrian/olap/fun/UnorderFunDef.java#2 $
 * @since Sep 06, 2008
 */
