...
public class MondrianResource extends org.eigenbase.resgen.ShadowResourceBundle {
    ...
    /**
     * <code>DimensionInIndependentAxes</code> is '<code>Dimension &#39;&#39;{0}&#39;&#39; appears in more than one independent axis.</code>'
     */
    ...
    /**
     * <code>InvalidAxis</code> is '<code>Invalid axis specification. The axis number must be non-negative integer, but it was {0,number}.</code>'
     */
    public final _Def8 InvalidAxis = new _Def8("InvalidAxis", "Invalid axis specification. The axis number must be non-negative integer, but it was {0,number}.", null);
    ...
    /**
     * <code>DupDimensionsInTuple</code> is '<code>Tuple contains more than one member of dimension &#39;&#39;{0}&#39;&#39;.</code>'
     */
     ...
     */
    public final _Def9 LimitExceededDuringCrossjoin = new _Def9("LimitExceededDuringCrossjoin", "Size of CrossJoin result ({0,number}) exceeded limit ({1,number})", null);

    /**
     * <code>TotalMembersLimitExceeded</code> is '<code>Total number of Members in result ({0,number}) exceeded limit ({1,number})</code>'
     */
    public final _Def9 TotalMembersLimitExceeded = new _Def9("TotalMembersLimitExceeded", "Total number of Members in result ({0,number}) exceeded limit ({1,number})", null);

    /**
     * <code>MemberFetchLimitExceeded</code> is '<code>Number of members to be read exceeded limit ({0,number})</code>'
     */
    public final _Def10 MemberFetchLimitExceeded = new _Def10("MemberFetchLimitExceeded", "Number of members to be read exceeded limit ({0,number})", null);

    /**
     * <code>QueryCanceled</code> is '<code>Query canceled</code>'
     */
    public final _Def11 QueryCanceled = new _Def11("QueryCanceled", "Query canceled", null);

    /**
     * <code>QueryTimeout</code> is '<code>Query timeout of {0,number} seconds reached</code>'
     */
    public final _Def12 QueryTimeout = new _Def12("QueryTimeout", "Query timeout of {0,number} seconds reached", null);

    /**
     * <code>IterationLimitExceeded</code> is '<code>Number of iterations exceeded limit of {0,number}</code>'
     */
    public final _Def10 IterationLimitExceeded = new _Def10("IterationLimitExceeded", "Number of iterations exceeded limit of {0,number}", null);

    /**
     * <code>InvalidHierarchyCondition</code> is '<code>Hierarchy &#39;&#39;{0}&#39;&#39; is invalid (has no members)</code>'
     */
    public final _Def13 InvalidHierarchyCondition = new _Def13("InvalidHierarchyCondition", "Hierarchy ''{0}'' is invalid (has no members)", null);

    /**
     * <code>TooManyMessageRecorderErrors</code> is '<code>Context &#39;&#39;{0}&#39;&#39;: Exceeded number of allowed errors &#39;&#39;{1,number}&#39;&#39;</code>'
     */
    public final _Def14 TooManyMessageRecorderErrors = new _Def14("TooManyMessageRecorderErrors", "Context ''{0}'': Exceeded number of allowed errors ''{1,number}''", null);

    /**
     * <code>ForceMessageRecorderError</code> is '<code>Context &#39;&#39;{0}&#39;&#39;: Client forcing return with errors &#39;&#39;{1,number}&#39;&#39;</code>'
     */
    public final _Def14 ForceMessageRecorderError = new _Def14("ForceMessageRecorderError", "Context ''{0}'': Client forcing return with errors ''{1,number}''", null);

    /**
     * <code>UnknownLevelName</code> is '<code>Context &#39;&#39;{0}&#39;&#39;: The Hierarchy Level &#39;&#39;{1}&#39;&#39; does not have a Level named &#39;&#39;{2}&#39;&#39;</code>'
     */
    public final _Def15 UnknownLevelName = new _Def15("UnknownLevelName", "Context ''{0}'': The Hierarchy Level ''{1}'' does not have a Level named ''{2}''", null);

    /**
     * <code>DuplicateLevelNames</code> is '<code>Context &#39;&#39;{0}&#39;&#39;: Two levels share the same name &#39;&#39;{1}&#39;&#39;</code>'
     */
    public final _Def16 DuplicateLevelNames = new _Def16("DuplicateLevelNames", "Context ''{0}'': Two levels share the same name ''{1}''", null);
     ...
     */
    public final _Def16 DuplicateMeasureNames = new _Def16("DuplicateMeasureNames", "Context ''{0}'': Two measures share the same name ''{1}''", null);

    /**
     * <code>DuplicateFactForeignKey</code> is '<code>Context &#39;&#39;{0}&#39;&#39;: Duplicate fact foreign keys &#39;&#39;{1}&#39;&#39; for key &#39;&#39;{2}&#39;&#39;.</code>'
     */
    public final _Def15 DuplicateFactForeignKey = new _Def15("DuplicateFactForeignKey", "Context ''{0}'': Duplicate fact foreign keys ''{1}'' for key ''{2}''.", null);
     ...
     */
    public final _Def15 UnknownLeftJoinCondition = new _Def15("UnknownLeftJoinCondition", "Context ''{0}'': Failed to find left join condition in fact table ''{1}'' for foreign key ''{2}''.", null);

    /**
     * <code>UnknownHierarchyName</code> is '<code>Context &#39;&#39;{0}&#39;&#39;: The Hierarchy &#39;&#39;{1}&#39;&#39; does not exist&quot;</code>'
     */
    public final _Def16 UnknownHierarchyName = new _Def16("UnknownHierarchyName", "Context ''{0}'': The Hierarchy ''{1}'' does not exist\"", null);

    /**
     * <code>BadLevelNameFormat</code> is '<code>Context &#39;&#39;{0}&#39;&#39;: The Level name &#39;&#39;{1}&#39;&#39; should be [usage hierarchy name].[level name].</code>'
     */
    public final _Def16 BadLevelNameFormat = new _Def16("BadLevelNameFormat", "Context ''{0}'': The Level name ''{1}'' should be [usage hierarchy name].[level name].", null);

    /**
     * <code>BadMeasureNameFormat</code> is '<code>Context &#39;&#39;{0}&#39;&#39;: The Measures name &#39;&#39;{1}&#39;&#39; should be [Measures].[measure name].</code>'
     */
    public final _Def16 BadMeasureNameFormat = new _Def16("BadMeasureNameFormat", "Context ''{0}'': The Measures name ''{1}'' should be [Measures].[measure name].", null);

    /**
     * <code>BadMeasures</code> is '<code>Context &#39;&#39;{0}&#39;&#39;: This name &#39;&#39;{1}&#39;&#39; must be the string &quot;Measures&quot;.</code>'
     */
    public final _Def16 BadMeasures = new _Def16("BadMeasures", "Context ''{0}'': This name ''{1}'' must be the string \"Measures\".", null);

    /**
     * <code>UnknownMeasureName</code> is '<code>Context &#39;&#39;{0}&#39;&#39;: Measures does not have a measure named &#39;&#39;{1}&#39;&#39;</code>'
     */
    public final _Def16 UnknownMeasureName = new _Def16("UnknownMeasureName", "Context ''{0}'': Measures does not have a measure named ''{1}''", null);

    /**
     * <code>NullAttributeString</code> is '<code>Context &#39;&#39;{0}&#39;&#39;: The value for the attribute &#39;&#39;{1}&#39;&#39; is null.</code>'
     */
    public final _Def16 NullAttributeString = new _Def16("NullAttributeString", "Context ''{0}'': The value for the attribute ''{1}'' is null.", null);

    /**
     * <code>EmptyAttributeString</code> is '<code>Context &#39;&#39;{0}&#39;&#39;: The value for the attribute &#39;&#39;{1}&#39;&#39; is empty (length is zero).</code>'
     */
    public final _Def16 EmptyAttributeString = new _Def16("EmptyAttributeString", "Context ''{0}'': The value for the attribute ''{1}'' is empty (length is zero).", null);
     ...
     */
    public final _Def15 BadMeasureName = new _Def15("BadMeasureName", "Context ''{0}'': Failed to find Measure name ''{1}'' for cube ''{2}''.", null);

    /**
     * <code>BadRolapStarLeftJoinCondition</code> is '<code>Context &#39;&#39;{0}&#39;&#39;: Bad RolapStar left join condition type: &#39;&#39;{1}&#39;&#39; &#39;&#39;{2}&#39;&#39;.</code>'
     */
    public final _Def15 BadRolapStarLeftJoinCondition = new _Def15("BadRolapStarLeftJoinCondition", "Context ''{0}'': Bad RolapStar left join condition type: ''{1}'' ''{2}''.", null);

    /**
     * <code>SqlQueryFailed</code> is '<code>Context &#39;&#39;{0}&#39;&#39;: Sql query failed to run &#39;&#39;{1}&#39;&#39;.</code>'
     */
    public final _Def16 SqlQueryFailed = new _Def16("SqlQueryFailed", "Context ''{0}'': Sql query failed to run ''{1}''.", null);
     ...
     */
    public final _Def15 UnknownFactTableColumn = new _Def15("UnknownFactTableColumn", "Context ''{0}'': For Fact table ''{1}'', the column ''{2}'' is neither a measure or foreign key\".", null);
     ...
     */
    public final _Def16 FailedCreateNewDefaultAggregateRules = new _Def16("FailedCreateNewDefaultAggregateRules", "Failed to create new default aggregate rules using property ''{0}'' with value ''{1}''.", null);

    /**
     * <code>CubeRelationNotTable</code> is '<code>The Cube &#39;&#39;{0}&#39;&#39; relation is not a MondrianDef.Table but rather &#39;&#39;{1}&#39;&#39;.</code>'
     */
    public final _Def16 CubeRelationNotTable = new _Def16("CubeRelationNotTable", "The Cube ''{0}'' relation is not a MondrianDef.Table but rather ''{1}''.", null);
     ...
     */
    public final _Def16 NoFactCountColumns = new _Def16("NoFactCountColumns", "Candidate aggregate table ''{0}'' for fact table ''{1}'' has no fact count columns.", null);

    /**
     * <code>NoMeasureColumns</code> is '<code>Candidate aggregate table &#39;&#39;{0}&#39;&#39; for fact table &#39;&#39;{1}&#39;&#39; has no measure columns.</code>'
     */
    public final _Def16 NoMeasureColumns = new _Def16("NoMeasureColumns", "Candidate aggregate table ''{0}'' for fact table ''{1}'' has no measure columns.", null);
     ...
     */
    public final _Def15 AggUnknownColumn = new _Def15("AggUnknownColumn", "Candidate aggregate table ''{0}'' for fact table ''{1}'' has a column ''{2}'' with unknown usage.", null);
     ...
     */
    public final _Def15 NoAggregatorFound = new _Def15("NoAggregatorFound", "No aggregator found while converting fact table aggregator: for usage\n        ''{0}'', fact aggregator ''{1}'' and sibling aggregator ''{2}''", null);
     ...
     */
    public final _Def16 AggTableZeroSize = new _Def16("AggTableZeroSize", "Zero size Aggregate table ''{0}'' for Fact Table ''{1}''.", null);
